...
Ext.define('Ticket.view.login.LoginModel', {
	...
	requires : [ 'Ticket.model.Organization' ],
	...
	stores : {
		/**
		 * @property {Ext.data.Store} organizations This store definition
		 *           populates the Organization combobox.
		 */
		organizations : {
			model : 'Organization',
			...
			// This ensures the Organization records are cached and distinct
			// going forward.
			session : true
		}
	}
